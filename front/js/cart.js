...
totalQuantity.innerHTML += `<span id="totalQuantity">${Number(quantityItem.reduce(reducer))}</span>`;
      ...
      document.location.href = `confirmation.html?orderId=${data.orderId}`;
        ...
        const errorFirstName = document.getElementById("firstNameErrorMsg");
          if (regexName.test(contact.firstName)){
            ...
            errorFirstName.innerHTML =
            `Veuillez correctement renseigner votre prénom.`;
          }
          ...
          if(regexCity.test(contact.city)){
            ...
            errorAdress.innerHTML =
            `Veuillez correctement renseigner votre adresse.`;
          }
