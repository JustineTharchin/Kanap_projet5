...
addToCart.addEventListener("click", (e) => { e.preventDefault();
...
console.log(saveItemCart);
    ...
    let index = item.findIndex(saveItemCart => saveItemCart['_id'] == idItem);
    let indexOption= item.findIndex(newSaveItemCart => newSaveItemCart['selectColors'] == itemOption.value);
